...
public class ProductAccess : IDataAccess<Product>
{
    ...
    public Task<IEnumerable<Product>> ListAsync(int? pageStart, int? pageSize, CancellationToken cancellationToken = default)
    {
        ...
        return Task.FromResult<IEnumerable<Product>>(queryable.ToList());
    }
}
